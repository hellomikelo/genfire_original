classdef GENFIRE_Class
  ...
  methods
    ...
    obj = fillInFourierGrid_DFT_GENFIREClass(obj)    
    obj = fillInFourierGrid_GENFIREClass(obj)
    obj = runGENFIREiteration_GENFIREClass(obj)
    obj = CentroSymmetricity_GENFIREClass(obj, FS, n1, n_k1, n2)
    ...
    function obj = runGridding(obj)      
        ...
        case 1
            obj = obj.fillInFourierGrid_GENFIREClass();
        case 2
            obj = obj.fillInFourierGrid_DFT_GENFIREClass();
        end
    ...
    function obj = runFSC(obj)
        ...
        obj = obj.runGENFIREiteration_GENFIREClass();        
